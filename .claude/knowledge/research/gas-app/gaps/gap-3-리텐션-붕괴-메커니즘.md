---
name: gas-app--gap-3-retention-collapse
description: 완성도 비평으로 보강한 갭 문서. 42matters 다운로드 데이터를 근거로 Gas의 실사용 붕괴가 Discord 인수 발표(2023-01-17)보다 8주 앞선 2022년 추수감사절 전후 이미 정점 대비 98% 진행됐음을 입증하고, 원인을 (1)2022-10 인신매매 괴담이라는 신뢰 충격, (2)창업자 본인이 실토한 구조적 K-factor 감쇠(나이 1살당 초대 발송 20% 감소), (3)변동보상 루프의 "가짜 답장 아니냐"는 의심에 따른 신뢰 붕괴 3갈래로 분석했다.
metadata:
  type: research
  topic: gas-app
  category: gaps
