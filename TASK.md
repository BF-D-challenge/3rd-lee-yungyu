...
- [x] **카드 아트 연결 완료(2026-07-06)** — [docs/card-art-integration.md](docs/card-art-integration.md)대로 `lib/card-art.ts` 경유: 슬롯 셀 앞면 축 엠블럼 + 뒷면 `CARD_BACK` 히어로, 확정 화면 who/how 보조 엠블럼, 랜딩 도메인 갤러리 10종. 덱 56장은 퍼포먼스상 경량 SVG 유지(문서 §3b 허용)
