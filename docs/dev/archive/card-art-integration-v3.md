# 카드 아트 연결 가이드 — 타로 덱 · 3티어 (v3, archived)

> Archived 2026-07-09: `src/lib/card-art.ts` and `TarotCard` have been removed from the runtime path. Keep this only as historical implementation context for the old tarot-card art system.
