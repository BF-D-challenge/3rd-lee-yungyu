...
`오늘 해볼까?`는 무엇을 만들지 모르는 초보 1인 빌더를 위한 **아이디어 슬롯 생성기**로, 랜덤 조합과 리믹스를 통해 바로 실행 가능한 앱 아이디어 1개와 AI 코딩 시작 프롬프트를 만든다.
...
![오늘 해볼까? 시작 페이지 목업](../assets/oneul-haebolkka-mockup-01-start.png)

#### 2. 슬롯 결과 페이지

![오늘 해볼까? 슬롯 결과 페이지 목업](../assets/oneul-haebolkka-mockup-02-slot.png)

#### 3. 리믹스 페이지

![오늘 해볼까? 리믹스 페이지 목업](../assets/oneul-haebolkka-mockup-03-remix.png)

#### 4. 실행 아이디어 페이지

![오늘 해볼까? 실행 아이디어 페이지 목업](../assets/oneul-haebolkka-mockup-04-final.png)
