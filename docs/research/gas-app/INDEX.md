---
name: gas-app--index
description: Gas 앱(10대 대상 익명 칭찬/투표 앱, 2022 출시~2023 Discord 인수 후 종료) 리서치 전체 12개 산출물의 목차·조사 방법·산출물 구조·핵심 발견 하이라이트를 정리한 안내 파일. 먼저 읽을 SUMMARY.md로 안내한다.
metadata:
  type: research
  topic: gas-app
  category: index
...
└── gaps/                        ← 완성도 비평으로 보강한 갭 4건 + 종합 분석 1건
    ...
    └── gap-5-K팩터-심리학-근본원인.md  ← 5 Whys·Hooked·Inversion으로 K>1 근본 원인 도출
```
