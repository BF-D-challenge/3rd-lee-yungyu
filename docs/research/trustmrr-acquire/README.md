...
- Collected at: `2026-07-05T06:47:55.876Z`
- Page result text: `1863 startups found`
- Unique startup cards saved: `1863`
- Method: loaded the infinite-scroll marketplace until all startup links were present in the DOM, then extracted card text.
- Raw capture: `.firecrawl/trustmrr-acquire/browser-cards-all.json` (ignored by Git).
...
- Start with [ideas.jsonl](ideas.jsonl) for acquisition-market signals.
- Use [../store-rankings/app-store-expanded-unique-apps.jsonl](../store-rankings/app-store-expanded-unique-apps.jsonl) to compare mobile app demand.
- Use [../store-rankings/chrome-webstore-expanded-unique-extensions.jsonl](../store-rankings/chrome-webstore-expanded-unique-extensions.jsonl) to compare browser-extension demand.
- Use `normalized_name` only for candidate matching; manually review matches before using them as evidence.

## JSONL Fields

- `id`, `name`, `slug`, `url`, `category`, `raw_category_text`, `raw_description`
- `revenue_30d_text`, `revenue_30d_value`, `growth_30d_text`, `asking_price_text`, `asking_price_value`, `multiple_text`
- `target_user`, `problem`, `current_alternative`, `opportunity`, `mvp_angle`, `tags`, `raw_card_text`
...
## Highest 30-Day Revenue Signals

- [1Lookup](https://trustmrr.com/startup/1lookup) — SaaS; revenue $398k, asking $10M, multiple 2.1x
- [S](https://trustmrr.com/startup/stealth-venture-15) — Stealth Venture; revenue $125k, asking $3M, multiple 2.0x
- [PROSP](https://trustmrr.com/startup/prosp) — Artificial Intelligence; revenue $98k, asking $1M, multiple 0.8x
- [Project A](https://trustmrr.com/startup/project-a) — Entertainment; revenue $86k, asking $5M, multiple 4.9x
- [Launch Club](https://trustmrr.com/startup/launch-club) — Marketing; revenue $64k, asking $3M, multiple 3.9x
- [GoTall](https://trustmrr.com/startup/gotall) — Health & Fitness; revenue $57k, asking $1M, multiple 1.5x
- [Mobile App](https://trustmrr.com/startup/mobile-app-4) — Mobile Apps; revenue $52k, asking $450k, multiple 0.7x
- [Doors Delivered](https://trustmrr.com/startup/doors-delivered) — E-commerce; revenue $52k, asking $650k, multiple 1.0x
- [P](https://trustmrr.com/startup/photo-sharing) — Photo Sharing; revenue $50k, asking $1.5M, multiple 2.5x
- [POST BRIDGE](https://trustmrr.com/startup/post-bridge) — Social Media; revenue $43k, asking $4.2M, multiple 8.2x
- [m](https://trustmrr.com/startup/mobile-app-5) — Uncategorized; revenue $43k, asking $950k, multiple 1.9x
- [SetSmart](https://trustmrr.com/startup/setsmart) — SaaS; revenue $43k, asking $499k, multiple 1.0x
- [Pushouse](https://trustmrr.com/startup/pushouse) — E-commerce; revenue $40k, asking $875k, multiple 1.8x
- [P](https://trustmrr.com/startup/private-enterprise-21) — Private Enterprise; revenue $37k, asking $1.5M, multiple 3.4x
- [imposter․ai](https://trustmrr.com/startup/imposter-ai) — Games; revenue $36k, asking $300k, multiple 0.7x
- [P](https://trustmrr.com/startup/hype-social-media-strategy) — Private Enterprise; revenue $36k, asking $1M, multiple 2.3x
- [Lunchbreak](https://trustmrr.com/startup/lunchbreak) — Education; revenue $33k, asking $1.5M, multiple 3.7x
- [Hyrox Fitness App](https://trustmrr.com/startup/hyrox-fitness-app) — Health & Fitness; revenue $32k, asking $3.8M, multiple 10.0x
- [Virlo](https://trustmrr.com/startup/virlo) — SaaS; revenue $32k, asking $1M, multiple 2.6x
- [Conductor](https://trustmrr.com/startup/conductor) — Developer Tools; revenue $31k, asking $1.3M, multiple 3.3x

## Lowest Asking-Price Seeds

- [AI Time Guardian](https://trustmrr.com/startup/ai-time-guardian) — SaaS; asking $1, revenue $0, multiple -
- [BookChain](https://trustmrr.com/startup/bookchain) — Social Media; asking $1, revenue $0, multiple -
- [60,000+ Weekly Users | 40,000+ daily Users | Chrome Extension | 3 Years Old | No Maintenance](https://trustmrr.com/startup/60-000-weekly-users-40-000-daily-users-chrome-extension-3-years-old-no-maintenance) — Productivity; asking $1, revenue $0, multiple -
- [Blupry](https://trustmrr.com/startup/blupry) — Design Tools; asking $10, revenue $0, multiple -
- [DutyClaw | OpenClaw MANAGED HOSTING](https://trustmrr.com/startup/dutyclaw-openclaw-managed-hosting) — Artificial Intelligence; asking $49, revenue $0, multiple -
- [Pipeline Pro](https://trustmrr.com/startup/pipeline-pro) — Productivity; asking $50, revenue $0, multiple -
- [beatthecrave](https://trustmrr.com/startup/beatthecrave) — Uncategorized; asking $50, revenue $0, multiple -
- [ReadyToRelease](https://trustmrr.com/startup/readytorelease) — Artificial Intelligence; asking $70, revenue $0, multiple -
- [NutriFriend](https://trustmrr.com/startup/nutrifriend) — Artificial Intelligence; asking $70, revenue $0, multiple -
- [ReplyPack](https://trustmrr.com/startup/replypack) — Artificial Intelligence; asking $75, revenue $0, multiple -
- [LiftMind](https://trustmrr.com/startup/liftmind) — Health & Fitness; asking $80, revenue $0, multiple -
- [o](https://trustmrr.com/startup/onlyyes) — Uncategorized; asking $99, revenue $0, multiple -
- [Exam Forge](https://trustmrr.com/startup/exam-forge) — Education; asking $99, revenue $0, multiple -
- [Paylog](https://trustmrr.com/startup/paylog) — Fintech; asking $99, revenue $0, multiple -
- [Notchclip](https://trustmrr.com/startup/notchclip) — Productivity; asking $100, revenue $4, multiple 1.9x
- [Dola](https://trustmrr.com/startup/dola) — Marketing; asking $100, revenue $7, multiple 1.2x
- [FluencyWave](https://trustmrr.com/startup/fluencywave) — Education; asking $100, revenue $0, multiple -
- [Signo](https://trustmrr.com/startup/signo) — Marketing; asking $100, revenue $0, multiple -
- [Pause - Habit & Urge Controller](https://trustmrr.com/startup/pause-habit-urge-controller) — Health & Fitness; asking $100, revenue $0, multiple -
- [Christmas-AI-Studio](https://trustmrr.com/startup/christmas-ai-studio) — Design Tools; asking $100, revenue $0, multiple -

## Fast PRD Candidate Pool

These are not recommendations yet; they are retrieval-friendly candidates in AI, creator, devtool, marketing, sales, design, productivity, and SaaS spaces.
...
- Treat each record as a market signal, not a product spec to copy.
- For PRD work, filter by category, revenue signal, asking price, and MVP angle.
- The card text is truncated by the source UI in some descriptions; use detail pages only for shortlisted ideas.
- `raw_category_text` preserves the card line that appeared where a category usually appears; `category` is normalized to the known marketplace categories when possible.
