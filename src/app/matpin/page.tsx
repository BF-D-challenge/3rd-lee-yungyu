...
const matpinTitle = "맛핀 | 맛집 릴스를 역별로 자동 정리";
const matpinDescription = "Instagram에서 matpin.kr 계정으로 맛집 릴스를 보내면 장소를 확인해 가까운 역별 보관함에 정리해요.";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{
      ...
      width: 1672,
      height: 941,
      alt: "Instagram 맛집 릴스를 matpin.kr로 보내 지도에 자동 정리하는 맛핀 이용 방법",
    }],
  },
  twitter: {
