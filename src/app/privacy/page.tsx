  ...
  return (
    <main className={styles.page}>
      ...
      <article className={styles.content}>
        ...
        <section><h2>2. 어떤 정보를 받나요?</h2><ul><li>Instagram이 만든 사용자 식별값과 메시지 식별값</li><li>matpin.kr로 공유한 공개 릴스의 주소와 임시 미디어 주소</li><li>영상에서 확인한 장소 단서, 장소 후보, 사용자가 저장한 장소</li><li>오류 확인에 필요한 처리 시각과 기술 기록</li></ul></section>
        <section><h2>3. 왜 사용하나요?</h2><p>보낸 릴스에서 식당과 카페 단서를 찾고, 실제 장소 후보를 확인해 개인 지도에 저장하며, Instagram 답장으로 결과 링크를 보내기 위해 사용합니다.</p></section>
        <section><h2>4. 어떤 서비스가 함께 처리하나요?</h2><ul><li>Meta: Instagram 메시지 수신과 답장</li><li>Google Gemini 및 Google Maps: 영상 단서 분석과 장소 후보 확인</li><li>Supabase: 암호화된 계정 연결 정보와 저장 장소 보관</li><li>Vercel: 맛핀 웹과 서버 기능 운영</li></ul></section>
        <section><h2>5. 얼마나 보관하나요?</h2><p>릴스 임시 미디어 주소는 분석이 끝나거나 최종 실패하면 제거합니다. 개인 지도 링크는 마지막 릴스를 받은 뒤 90일 동안 유효합니다. 사용자가 직접 삭제하면 계정 연결 정보, 처리 기록, 저장 장소를 즉시 함께 삭제합니다.</p></section>
