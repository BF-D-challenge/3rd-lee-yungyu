  ...
  return (
    <main className={styles.page}>
      ...
      <article className={styles.content}>
        ...
        <section><h2>1. 제공하는 기능</h2><p>맛핀은 사용자가 matpin.kr로 공유한 공개 Instagram 릴스, 피드 게시물과 캐러셀에서 장소 단서를 찾고, 실제 장소 후보를 확인해 개인 지도에 저장합니다.</p></section>
        <section><h2>2. 결과 확인</h2><p>게시물이나 지도 정보가 불분명하면 잘못된 후보가 나올 수 있습니다. 맛핀은 확신이 낮을 때 사용자의 확인을 요청합니다. 방문 전에는 원본 게시물과 지도 정보를 다시 확인해주세요.</p></section>
        <section><h2>3. 사용할 수 없는 콘텐츠</h2><p>비공개 게시물, 접근 권한이 없는 콘텐츠, 타인의 권리를 침해하는 콘텐츠는 처리하지 않습니다. DM으로 직접 보낸 글, 이미지와 동영상도 분석하지 않습니다. 사용자는 자신이 Instagram에서 정상적으로 공유할 수 있는 공개 게시물만 보내야 합니다.</p></section>
